...
export default function StudentPortalLayout({
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case "portfolio":
        return <PortfolioTab studentId={student.id} />;
      case "shop":
        return (
          <ComingSoonTab
            title="SHOP"
            description="Spend your adcoins on exclusive rewards and power-ups."
          />
        );
      case "missions":
        return (
          <ComingSoonTab
            title="MISSIONS"
            description="Complete missions to earn bonus adcoins and achievements."
          />
        );
    }
  };
    ...
    >
      ...
      <main className="flex-1 flex items-center justify-center px-3 py-2 sm:px-6 sm:py-4">
        ...
        >
          ...
          {/* Portfolio navigation arrows — left & right edges, vertically centred */}
          {activeTab === "portfolio" && (
            <>
              {/* Previous (left) */}
              <button
                type="button"
                className="absolute z-20 top-1/2 -translate-y-1/2 bg-transparent border-0 p-0 cursor-pointer transition-transform hover:scale-110 active:scale-95"
                style={{ width: "clamp(35px, 5vw, 55px)", left: "clamp(-28px, -4vw, -45px)" }}
                aria-label="Previous"
              >
                <svg viewBox="0 0 132 240" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
                  <path d="M66.5 237.142L101.186 213.209C108.896 207.889 113.5 199.12 113.5 189.752V50.9922L113.487 50.1289C113.218 41.2219 108.792 32.9319 101.499 27.7539L66.5 2.90332V237.142Z" fill="url(#pp0)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="100.5" width="23" height="17" fill="url(#pp1)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="122.5" width="23" height="17" fill="url(#pp2)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="144.5" width="23" height="17" fill="url(#pp3)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="78.5" width="23" height="17" fill="url(#pp4)" stroke="black" strokeWidth="3"/>
                  ...
                  <path d="M17.7096 132.136C10.5503 124.455 10.5503 112.545 17.7096 104.864L60.3695 59.0936C72.7507 45.8097 95 54.5707 95 72.7298L95 164.27C95 182.429 72.7507 191.19 60.3695 177.906L17.7096 132.136Z" fill="url(#pp5)"/>
                  ...
                  <defs>
                    <linearGradient id="pp0" x1="115" y1="120" x2="65" y2="120" gradientUnits="userSpaceOnUse"><stop offset="0.6" stopColor="#DB433B"/><stop offset="0.61" stopColor="#B02727"/></linearGradient>
                    <linearGradient id="pp1" x1="129" y1="109" x2="109" y2="109" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="pp2" x1="129" y1="131" x2="109" y2="131" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="pp3" x1="129" y1="153" x2="109" y2="153" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="pp4" x1="129" y1="87" x2="109" y2="87" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="pp5" x1="65" y1="6.99998" x2="65" y2="106.166" gradientUnits="userSpaceOnUse"><stop offset="0.65" stopColor="#FDC990"/><stop offset="1" stopColor="#F57E3B"/></linearGradient>
                  </defs>
                </svg>
              </button>

              {/* Next (right) — same SVG flipped horizontally */}
              <button
                type="button"
                className="absolute z-20 top-1/2 -translate-y-1/2 bg-transparent border-0 p-0 cursor-pointer transition-transform hover:scale-110 active:scale-95"
                style={{ width: "clamp(35px, 5vw, 55px)", right: "clamp(-28px, -4vw, -45px)" }}
                aria-label="Next"
              >
                <svg viewBox="0 0 132 240" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto" style={{ transform: "scaleX(-1)" }}>
                  <path d="M66.5 237.142L101.186 213.209C108.896 207.889 113.5 199.12 113.5 189.752V50.9922L113.487 50.1289C113.218 41.2219 108.792 32.9319 101.499 27.7539L66.5 2.90332V237.142Z" fill="url(#np0)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="100.5" width="23" height="17" fill="url(#np1)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="122.5" width="23" height="17" fill="url(#np2)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="144.5" width="23" height="17" fill="url(#np3)" stroke="black" strokeWidth="3"/>
                  <rect x="107.5" y="78.5" width="23" height="17" fill="url(#np4)" stroke="black" strokeWidth="3"/>
                  <path d="M11.7441 134.711C3.98363 126.439 3.98363 113.561 11.7441 105.289L61.8203 51.915C75.1532 37.7038 98.9998 47.1385 99 66.625L99 173.375C98.9998 192.862 75.1532 202.296 61.8203 188.085L11.7441 134.711Z" fill="#D9D9D9" stroke="black" strokeWidth="3"/>
                  <path d="M13.5674 133C6.70947 125.69 6.70947 114.31 13.5674 107L63.6436 53.625C75.4262 41.0664 96.4998 49.4044 96.5 66.625L96.5 173.375C96.4998 190.596 75.4262 198.934 63.6436 186.375L13.5674 133Z" fill="#D46836" stroke="white" strokeWidth="2"/>
                  <path d="M17.7096 132.136C10.5503 124.455 10.5503 112.545 17.7096 104.864L60.3695 59.0936C72.7507 45.8097 95 54.5707 95 72.7298L95 164.27C95 182.429 72.7507 191.19 60.3695 177.906L17.7096 132.136Z" fill="url(#np5)"/>
                  <path d="M20.6642 132.621C12.1932 124.714 12.1933 111.286 20.6643 103.379L61.3533 65.4008C74.1375 53.4682 95 62.5337 95 80.0216L95 155.978C95 173.466 74.1375 182.532 61.3533 170.599L20.6642 132.621Z" fill="#FBA73F"/>
                  <path d="M44.8866 123.646C42.7814 121.671 42.7814 118.329 44.8866 116.354L68.5789 94.1256C71.7718 91.1301 77 93.3939 77 97.772V142.228C77 146.606 71.7718 148.87 68.5789 145.874L44.8866 123.646Z" fill="#D46836"/>
                  <ellipse cx="78.3886" cy="55.8832" rx="6" ry="3" transform="rotate(8.80601 78.3886 55.8832)" fill="white"/>
                  <defs>
                    <linearGradient id="np0" x1="115" y1="120" x2="65" y2="120" gradientUnits="userSpaceOnUse"><stop offset="0.6" stopColor="#DB433B"/><stop offset="0.61" stopColor="#B02727"/></linearGradient>
                    <linearGradient id="np1" x1="129" y1="109" x2="109" y2="109" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="np2" x1="129" y1="131" x2="109" y2="131" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="np3" x1="129" y1="153" x2="109" y2="153" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="np4" x1="129" y1="87" x2="109" y2="87" gradientUnits="userSpaceOnUse"><stop offset="0.29" stopColor="#B02828"/><stop offset="0.3" stopColor="#DB443C"/></linearGradient>
                    <linearGradient id="np5" x1="65" y1="6.99998" x2="65" y2="106.166" gradientUnits="userSpaceOnUse"><stop offset="0.65" stopColor="#FDC990"/><stop offset="1" stopColor="#F57E3B"/></linearGradient>
                  </defs>
                </svg>
              </button>
            </>
          ...
          <div
            className={`relative z-10 px-6 pt-8 pb-5 sm:px-10 sm:pt-12 sm:pb-8 ${activeTab === "ranking" || activeTab === "transfer" ? "overflow-visible" : "overflow-y-auto"}`}
            style={{ minHeight: "420px", maxHeight: activeTab === "ranking" || activeTab === "transfer" ? undefined : "calc(100svh - 180px)" }}
          >
            {renderTab()}
          </div>
        </div>
