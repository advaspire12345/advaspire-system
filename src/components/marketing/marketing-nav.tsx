    ...
    >
      <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Staff Login — desktop only; on mobile it's in the burger menu */}
          <Link
            href="/login"
            className="hidden lg:inline-flex items-center gap-1.5 rounded-full border border-[#1A1A2E]/15 bg-white/70 px-4 py-2.5 text-xs font-bold text-[#1A1A2E] uppercase tracking-widest hover:bg-white transition-colors"
          >
          ...
          {/* Free Trial — desktop only; on mobile it's in the burger menu */}
          <a
            href="#trial"
            className="group relative hidden lg:inline-flex items-center gap-2 rounded-full bg-[#1A1A2E] px-5 py-2.5 text-xs font-bold text-white uppercase tracking-widest transition-all hover:bg-[#E91E96] shadow-[0_8px_24px_-10px_rgba(26,26,46,0.6)] hover:shadow-[0_12px_28px_-10px_rgba(233,30,150,0.55)]"
          >
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t border-[#1A1A2E]/10 bg-[#FAF7F2]">
          ...
          {/* Login + Trial live here on mobile (kept off the top bar) */}
          <div className="px-4 pb-5 pt-1 space-y-2">
            <Link
              href="/login"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center gap-2 rounded-full border border-[#1A1A2E]/15 bg-white px-4 py-3 text-sm font-bold text-[#1A1A2E] uppercase tracking-widest"
            >
              <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                <path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4M10 17l5-5-5-5M15 12H3" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            ...
            <a
              href="#trial"
              onClick={() => setMobileOpen(false)}
              className="flex items-center justify-center gap-2 rounded-full bg-[#1A1A2E] px-4 py-3 text-sm font-bold text-white uppercase tracking-widest"
            >
              Free Trial
