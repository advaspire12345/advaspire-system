  ...
  return createPortal(
    <>
      <style>{`
        ...
        @keyframes meteor-orbit {
          ...
          55%  { opacity: 1; }
          64%  { offset-distance: 125%; opacity: 0; }
    ...
    <div className="fixed inset-0 flex items-center justify-center p-4" style={{ zIndex: 99999 }}>
      ...
      <div className="relative overflow-visible pointer-events-none" style={{ width: "fit-content", animation: "modal-grow 0.4s cubic-bezier(0.34, 1.56, 0.64, 1) forwards" }}>
        ...
        {/* Board — img-based sizing */}
        <div className="relative pointer-events-auto" style={{ width: "clamp(240px, 65vw, 340px)", zIndex: 2 }}>

          {/* Meteor orbiting the board edge */}
          <div
            className="absolute pointer-events-none meteor-track"
            style={{
              width: "12px",
              height: "12px",
              borderRadius: "50%",
              ...
              zIndex: 5,
              offsetRotate: "0deg",
              animation: "meteor-orbit 2.8s cubic-bezier(0.4, 0, 0.6, 1) infinite",
              animationDelay: "0.3s",
              opacity: 0,
              top: "0px",
              left: "0px",
          ...
          />
          {/* Close button — top-right corner, half outside */}
          <button
            onClick={onClose}
            className="absolute z-30 hover:brightness-110 active:scale-90 transition-all"
          ...
          <form onSubmit={handleSubmit} className="absolute z-20 flex flex-col justify-center gap-2.5 sm:gap-3" style={{ top: "0", left: "8%", right: "8%", bottom: "0" }}>
            {/* Header */}
            <h3 className="text-amber-300 font-bold tracking-wider text-center" style={{ fontFamily: "monospace", fontSize: "clamp(10px, 2.2vw, 14px)", textShadow: "0 0 6px rgba(245,158,11,0.3)" }}>
              SEND ADCOINS
            </h3>
            ...
            <div style={fieldBox}>
              ...
              <div className="truncate" style={{ ...fieldInput, cursor: "default" }}>
          ...
          {/* Confirm button — straddles bottom edge */}
          <button
            type="button"
